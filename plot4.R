...
#setup a two-by-two partition for to hold the 4 plots
par(mfrow=c(2,2))

#plot the first row - time series plots of Global Active Power and Voltage 
plot( powerConsumption$Date, powerConsumption$Global_active_power, 
      type="l", xlab="", ylab="Global Active Power (kilowatts)")
plot( powerConsumption$Date, powerConsumption$Voltage, 
...
#plot the bottom left chart as a time series overlaying 3 datasets and a legend
...
#plot the bottom right chart as a time series of Global reactive power
plot( powerConsumption$Date, powerConsumption$Global_reactive_power, 
